...
\titulo
\textbf{Propuestas de la Comunidad Universitaria y la Delegación de Alumnos de la ETSIT UPM para las candidaturas a director/a 2024}

\textbf{\textcolor{DATorange}{%CANDIDATE%}}
...
\cuerpo{
    ...
    motivo de las elecciones a director/a de la UPM de este 2025, se ha realizado una recogida de
